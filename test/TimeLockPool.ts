...
import { MockToken__factory, TimeLockPool__factory } from "../typechain-types";
import { MockToken } from "../typechain-types";
import { TimeLockPool } from "../typechain-types/TimeLockPool";
...
describe("TimeLockPool", function () {
    ...
    before(async() => {
        ...
        const testTokenFactory = await new MockToken__factory(deployer);
